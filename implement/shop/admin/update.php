...
$ID = $_GET['id'];
$up = mysqli_query($conn, "SELECT * FROM products WHERE product_id = $ID");
...
if (isset($_POST['update'])) {
    ...
    $price = $_POST['price'];
    $amount=$_POST['amount'];
    $image_name = $data['image']; // Default to existing image if no new image is uploaded
    ...
    $update_query = "UPDATE products SET name = '$name', price = '$price',amount = '$amount', image = '$image_name' WHERE product_id = $ID";
    ...
    <div class="main-container">
        <div class="form-container">
            <form action="" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="input-group">
                    <label for="name">New Amount</label>
                    <input type="text" id="name" name="amount" required value="<?php echo $data['amount']; ?>">
                </div>
